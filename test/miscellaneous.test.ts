...
describe('miscellaneous', () => {
  it('getLiquidityMinted:0', async () => {
    const tokenA = new Token(SupportedChainId.MAINNET, '0x0000000000000000000000000000000000000001', 18)
    const tokenB = new Token(SupportedChainId.MAINNET, '0x0000000000000000000000000000000000000002', 18)
    const pair = BasicPair(CurrencyAmount.fromRawAmount(tokenA, '0'), CurrencyAmount.fromRawAmount(tokenB, '0'))
    ...
    expect(liquidity.numerator.toString()).toEqual('1')
  })

  it('getLiquidityMinted:!0', async () => {
    const tokenA = new Token(SupportedChainId.MAINNET, '0x0000000000000000000000000000000000000001', 18)
    const tokenB = new Token(SupportedChainId.MAINNET, '0x0000000000000000000000000000000000000002', 18)
    const pair = BasicPair(CurrencyAmount.fromRawAmount(tokenA, '10000'), CurrencyAmount.fromRawAmount(tokenB, '10000'))
  ...
  it('getLiquidityValue:!feeOn', async () => {
    const tokenA = new Token(SupportedChainId.MAINNET, '0x0000000000000000000000000000000000000001', 18)
    const tokenB = new Token(SupportedChainId.MAINNET, '0x0000000000000000000000000000000000000002', 18)
    const pair = BasicPair(CurrencyAmount.fromRawAmount(tokenA, '1000'), CurrencyAmount.fromRawAmount(tokenB, '1000'))

    {
      ...
      expect(liquidityValue.numerator.toString()).toBe('1000')
    }
    ...
    // 500
    {
      ...
      expect(liquidityValue.currency.equals(tokenA)).toBe(true)
      expect(liquidityValue.numerator.toString()).toBe('500')
    }
  ...
  it('getLiquidityValue:feeOn', async () => {
    ...
    expect(liquidityValue.currency.equals(tokenA)).toBe(true)
    expect(liquidityValue.numerator.toString()).toBe('917') // ceiling(1000 - (500 * (1 / 6)))
  })
