...
describe('Route', () => {
  ...
  const pair_0_1 = BasicPair(new TokenAmount(token0, '100'), new TokenAmount(token1, '200'))
  const pair_0_weth = BasicPair(new TokenAmount(token0, '100'), new TokenAmount(weth, '100'))
  const pair_1_weth = BasicPair(new TokenAmount(token1, '175'), new TokenAmount(weth, '100'))
